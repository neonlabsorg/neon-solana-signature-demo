...
async function main() {
    ...
    let createWithSeedAccount =  await iterativeComposability.getCreateWithSeedAccount(
        contractPublicKeyInBytes,
        Buffer.from(seed)
    )
    console.log(createWithSeedAccount, 'createWithSeedAccount')

    let resource =  await iterativeComposability.getResourceAddress(Buffer.from(seed))
    console.log(resource, 'resource')

    console.log('\nCalling iterativeComposability.testCreateTokenMintResource: ')

    let tx = await iterativeComposability.testCreateTokenMintResource(
    ...
    resource =  await iterativeComposability.getResourceAddress(Buffer.from(seed))
    console.log(resource, 'resource')
}
